...
ワークショップは初心者向けのものから、インタラクティブ／グラフィック／デザイン／機械学習といった様々なテーマに特化して幅広く用意します。ワークショップは少人数に参加を限った集中型としてデザインされ、講師と対話しながら学ぶことができます。初心者や独学者はもちらん、習熟者も発見を得られるものとなるでしょう。講演登壇者やワークショップ講師、スケジュール等は、本番に向けて順次公開していきます。

# 1.1. ご支援のお願い

Processing Community Day Tokyoは現在、100%ボランティアによって成り立っています。チケット代は講師や講演者の謝礼にあてるという最小限の運営構成をとっています。そのため、講師謝礼以外の実費（Webや紙面の作業負担や諸経費）はボランティア個人の持ち出しで行われています。
...
特記事項は以下です。
* イベントは本ファンディングの達成／未達成に関わらず、実施されます。
* 利益を出すことを一切目的とせず、実負担より超過した分はすべてProcessing Foundationに寄付いたします。
* 運営費用についてはすべて事後公開されます。


# 1.1. PCD Tokyo クラウドファンディング発起人

## 永松歩

![anagamat](./images/anagamat.jpg)
...
## 1.3. Processing Community Day(PCD)について
...
引用元: [Processing Community Day Tokyo をやります | 永松 歩 | Ayumu Nagamatsu](https://ayumu-nagamatsu.com/archives/855/)
...
Processing Community Day実施に際しての費用として、主に講師の方への謝礼金／交通費が30万円程度がかることを見込んでおり、その分はチケットの売り上げでカバーされます。

**それ以外のイベントに関する諸経費のすべて**（Webやハンドアウトなどの制作費用、ワークショップなどで発生する備品経費、ボランティアの交通費など）が、今回の資金の使いみちとなります。有志の方々からのご支援を募りたく、CAMPFIRE手数料も見込んで、250,000円を目標金額にします。
...
リターンについては現在、作品の進呈を用意しております。今後、追加されていく可能性がございます。
...
オーガナイザーや講師がプログラミングによって出力したGenerative Artの平面静止画作品を、プリントとして進呈します。作家は、永松歩、稗田直人を始め、順次追加いたします。各画像出力は各フォーマット限定5枚で、エディション番号と作者のサインが記載されます（画像データの場合は番号と合わせてメールでお送りします）。

|コース|支援額|作家|説明|
|-|-|-|-|
|4K静止画データコース|5,000円|稗田|4Kサイズ(3840×2160)のGenerative Art画像データを進呈いたします。|
|A3プリントコース|10,000円|稗田|A3サイズ(297mmx420mm)のプリントを進呈いたします。
|A3額装コース|20,000円|稗田、永松|A3サイズ(297mmx420mm)のプリントを額装して進呈いたします。
|大判プリントコース|50,000円|稗田、永松|A1サイズ(594mmx841mm)のプリントを進呈いたします。



## 4. 最後に

今回のProcessing Community Day Tokyoを通して多様なバックグラウンドを持つ方々とをつなげ、たくさんのきっかけをつくり、デザインとプログラミング、アートやテクノロジーを横断した活動をもっともっと活性化させていけたらと、企画チーム一同考えて準備にあたっています。

みなさまのご協力、心よりよろしくお願いいたします！
